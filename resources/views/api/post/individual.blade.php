...
@section('content')
	<div class="post-card article-card">
		<div class="card vertical post-card-content">
			<div class="post-user-profile">
				<div class="card-image article-avatar"><img class="circle" src="{{$post->getAuthor->avatar}}" /></div>
			</div>
	...
	<div class="post-card article-card comment-card">
		...
		<div class="card vertical post-card-content">
			<div class="post-user-profile">
				<div class="card-image"><img class="circle" src="{{$comment->getAuthor->avatar}}" /></div>
				<div class="post-header-container">
