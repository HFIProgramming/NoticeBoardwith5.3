				...
				<div class="card-action">
					<div class="row post-card-heading no-margin">
						...
						@if (strtotime($vote->ended_at) - strtotime('now') >= 0)
							<div class="col l4 right"><a href="{{url('/vote/id/'.$vote->id.'ticket'.$ticket)}}">Vote Now!</a></div>
				...
				<div class="card-stacked">
					<div class="card-content display-all">
						...
						<div class="tag-container">
							<button class="tag-btn btn-flat waves-effect waves-light">开始时间：{{$vote->started_at}}</button>
